...
use App\Notifications\NewProductVersionSoonNotification;
...
class SendEmailToClientsWithNewVersionSoon implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $clients->chunk(100, function ($users) {
            foreach ($users as $user) {
                $user->notify(new NewProductVersionSoonNotification($this->version));
            }
        });
    }
}
