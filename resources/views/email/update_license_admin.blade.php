...
@section('content')
    ...
    <tr>
        <td style="border-radius: 5px; background-color: #F5F6FA; padding: 30px; ">
            ...
            <p style="color:#383B37; font-size: 14px; font-family:Almarai; ">
                {{ __('mail.update_license_content_admin', ['license_code' => $license->license_code, 'product' => $product->name]) . ' ' . ' In ' . $client->name . ' Company'}}
            </p>
        </td>
    </tr>
