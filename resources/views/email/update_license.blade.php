...
@section('content')
    ...
    <tr>
        <td style=" padding-bottom: 10px; text-align: center;">
            <p style="color:#595874; font-size: 16px; margin: 0; font-weight: bold; font-family:Almarai;">{{ __('mail.update_license_title') }}</p>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td style="border-radius: 5px; background-color: #F5F6FA; padding: 30px; ">
            ...
            <p style="color:#595874; font-size: 14px; font-family:Almarai; ">
                {{ __('mail.update_license_content', ['license_code' => $license->license_code, 'product' => $product->name]) }}
            </p>
        </td>
    </tr>
