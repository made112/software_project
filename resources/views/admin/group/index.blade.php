                        ...
                        <div class="d-flex align-items-center">
                            <div class="mr-auto">
                                ...
                                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                                    ...
                                    <li class="m-nav__item">
                                        <a href="#" class="m-nav__link ">
                                            <span class="m-nav__link-text text-dark">{{trans('lang.groups')}}</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
        ...
        <div class="data-content">
            <div class="row ">
                <div class="col-md-12 mb-4">
                    <h5 class="font-weight-bold float-left">{{trans('lang.manage_groups')}}</h5>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12">
                    <div class="table-container" id="table-container">
                        @include('admin.group.table-data')
                    </div>
                </div>
            </div>
        </div>

        @include('admin.group.sub.add')
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.btnAddGroup', function () {
                ...
                $('#add_page .modal-title').html("{{ trans('lang.add_group') }}");
                $('#add_page').modal('show');
            });
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data['status'] == true) {
                            ...
                            var arr = [];
                            $.each( data['data']['group_roles'], function(key, value) {
                                arr[key] = value.id;
                            });
