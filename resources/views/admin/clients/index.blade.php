                        ...
                        <div class="d-flex align-items-center">
                            <div class="mr-auto">
                                ...
                                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                                    ...
                                    <li class="m-nav__item">
                                        <a href="#" class="m-nav__link ">
                                            <span class="m-nav__link-text text-dark">{{ trans('lang.companies') }}</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
        ...
        <div class="data-content">
            <div class="row ">
                <div class="col-md-12 mb-4">
                    <h5 class="font-weight-bold">{{ trans('lang.manage_companies') }}</h5>
                ...
                <div class="col-md-10 col-lg-10 mb-4">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <input type="text" class="name form-control reset-filter" name="name" autocomplete="off"
                                placeholder="{{ trans('lang.name') }}">
                        </div>
                        <div class="col-md-3">
                            <input type="text" class="email form-control reset-filter" name="email" autocomplete="off"
                                placeholder="{{ trans('lang.email') }}">
                        </div>
                        <div class="col-md-3">
                            <select name="country_id" id="country_id" class="country_id form-control reset-filter">
                                <option value="">{{ trans('lang.country') }}</option>
                                @if ($data['counrty'])
                        ...
                        <div class="col-md-2 mt-3  align-self-center">
                            <button type="button"
                                class="btn btn-md reset btn-info float-right">{{ trans('lang.reset') }}</button>
                        </div>
                    </div>
                </div>
                <div class="col-md-2 col-lg-2 mb-4 text-right">
                    @can('add_clients')
                        <a href="{{ route('admin.clients.create') }}" class="btn btn-md btn-black text-white"><i
                                class="fa fa-plus"></i> {{ trans('lang.add_company') }}</a>
                    @endcan
                </div>
            </div>
...
@section('js')
    <script>
        ...
        $(document).on('change', '.country_id,.from,.to', function(e) {
            var url = $(this).attr('href');
            getData(url);
        });
