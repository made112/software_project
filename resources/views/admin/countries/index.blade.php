                        ...
                        <div class="d-flex align-items-center">
                            <div class="mr-auto">
                                ...
                                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                                    ...
                                    <li class="m-nav__item">
                                        <a href="#" class="m-nav__link ">
                                            <span class="m-nav__link-text text-dark">{{ trans('lang.country') }}</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
        ...
        <div class="data-content">
            <div class="row ">
                <div class="col-md-12 mb-4 ">
                    <h5 class="font-weight-bold float-left">{{ trans('lang.manage') . ' ' . __('lang.country') }}</h5>
...
@section('js')
    <script>
        ...
        $(document).on('click', '.country_status', function(e) {
            e.preventDefault();
            var id = $(this).data('id');
            $('#load').show();
            $.ajaxSetup({
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var element = $('.country_status[data-id="' +  data.country.id + '"]')

                    if (data.country.status) {
