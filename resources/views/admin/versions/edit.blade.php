                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="/admin/versions/{{$product_id}}" class="m-nav__link ">
                                <span class="m-nav__link-text text-dark"  style="font-weight:bold">{{trans('lang.versions')}}</span>
                            </a>
                        </li>
                        <li class="m-nav__item">
                            <a href="#" class="m-nav__link ">
                        ...
                        <li class="m-nav__item">
                            <a href="#" class="m-nav__link ">
                                <span class="m-nav__link-text text-dark">{{trans('lang.edit_version')}}</span>
                            </a>
                        </li>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12">
                ...
                <h3 class="m-portlet__head-text" style="font-weight: bold">
                    {{trans('lang.edit')}} {{$product->name}} {{trans('lang.version')}}
                </h3>
                </div>
                </div>
                </div>
                    <div class="m-portlet__body">
                        <form action="{{route('admin.versions.update')}}" class="add_version_form" method="post">
                            ...
                            <div class="form-group row">
                                <div class="col-md-6 col-lg-6">
                                    ...
                                    <input type="text" name="name" id="name" class="name form-control" value="{{$versions->name}}" @if($versions->publish_version == 1) style="pointer-events: none" @endif placeholder="{{trans('lang.version_name')}}">
                                </div>
                                <div class="col-md-3 col-lg-3 date_div" >
                                    ...
                                    <div class="float-right">
                                        <input type="checkbox" class="publish_version" id="publish_version" name="publish_version" @if($versions->publish_version == 1) checked @endif @if($versions->publish_version == 1) style="pointer-events: none" @endif>
                                        <label for="publish_version" @if($versions->publish_version == 1) style="pointer-events: none" @endif>
                                            <div class="position-relative">
                                    ...
                                    <input type="text" name="date" id="date" @if($versions->publish_version == 1) style="pointer-events: none;" @endif class="date date-picker form-control" @if($versions->publish_version == 1) style="pointer-events: none" @endif  value="{{ $versions->date }}" placeholder="{{trans('lang.publish_date')}}">
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <input type="text" name="notification_summry" id="notification_summry"  value="{{$versions->notification_summry}}" @if($versions->publish_version == 1) style="pointer-events: none" @endif class="notification_summry form-control" placeholder="{{trans('lang.notification_summry')}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <input type="text" name="branch" id="name" class="name form-control" value="{{ $versions->branch }}" @if($versions->publish_version == 1) style="pointer-events: none" @endif placeholder="Branch">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <textarea name="change_log" id="change_log" class="change_log form-control ckeditor" cols="30" rows="5" placeholder="{{trans('lang.change_log')}}" @if($versions->publish_version == 1) readonly @endif>{{$versions->change_log}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6 col-lg-6">
                                    ...
                                    <input type="file" name="main_files" id="main_files" class="main_files form-control" placeholder="{{trans('lang.main_files')}}" @if($versions->publish_version == 1) style="pointer-events: none" @endif>
                                    @if($versions->main_files)
                                        <a href="{{$versions->main_files}}" download>{{trans('lang.download_file')}}</a>
                                    @endif
                                </div>
                                <div class="col-md-6 col-lg-6">
                                    <label for="name">
                                    ...
                                    <input type="file" name="sql_files" id="sql_files" class="sql_files form-control" placeholder="{{trans('lang.sql_files')}}" @if($versions->publish_version == 1) style="pointer-events: none" @endif>
                                    @if($versions->sql_files)
                                        <a href="{{$versions->sql_files}}" download>{{trans('lang.download_file')}}</a>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12 col-lg-12">
                                    <input type="checkbox" class="block" id="block" name="block" @if($versions->block == 1) checked @endif>
                                    <label for="block">
...
<script>
    function CKupdate(){
     ...
     $('.add_version_form').on('submit', function(e){
            ...
            $.ajax({
                url: "{{route('admin.versions.update')}}",
                type: "post",
                cache:false,
                contentType: false,
                processData: false,
                ...
                success: function (data) {
                    ...
                    if (data["status"] == true) {
                        ...
                        location.replace("{{route('admin.versions.index',['product_id'=>$product_id])}}");
                    } else {
                        swal({
                            title: "",
                            text: data["data"],
