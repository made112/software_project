					...
					<div class="col-xl-5 col-lg-6 col-md-8">
						<div class="card mb-4">
							<div class="section-title text-center mb-4">
								...
								<h1 class="title">{{trans('lang.welcome_back')}}</h1>
								<h2 class="sub-title">{{trans('lang.login_to_continue_to')}} Software</h2>
							</div>
							<div class="form">
								<form action="{{URL::to('/')}}/admin/adminlogin" method="post" class="needs-validation" novalidate>
                                    {{ csrf_field() }}
									...
									<div class="form-group mb-3">
										<label for="" class="form-label mb-2">{{trans('lang.username')}}</label>
										<input type="text" class="form-control" name="username" placeholder="{{trans('lang.username')}}" required>
										<div class="invalid-feedback">{{trans('lang.user_name_required')}}</div>
									</div>
									<div class="form-group">
										<label for="" class="form-label mb-2">{{trans('lang.password')}}</label>
										<div class="password-box">
											<input type="password" name="password" id="password" class="form-control " placeholder="{{trans('lang.password')}}" required>
                                            <span class="show-hide-password"> <i class="fa fa-eye"></i> </span>
                                        </div>
										{{-- <div class="invalid-feedback">{{trans('lang.password_required')}}</div> --}}
										<div class="text-end mt-2">
											<a href="{{URL::to('/')}}/admin/forget-password" class="forget-password">{{trans('lang.forget-password')}}?</a>
										</div>
									</div>
