            ...
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="#" class="m-nav__link ">
                                <span class="m-nav__link-text text-dark">{{trans('lang.edit_product')}}</span>
                            </a>
                        </li>
                        ...
                        <form action="{{route('admin.products.add')}}" class="add_product_form" method="post">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <input type="text" value="{{$products->name}}" name="name" id="name" class="name form-control" placeholder="{{trans('lang.name')}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-4 col-lg-4">
                                    ...
                                    <select name="status" class="status form-control" id="status">
                                        ...
                                        <option value="1" @if($products->status == 1) selected @endif>{{trans('lang.active')}}</option>
                                        <option value="2" @if($products->status == 2) selected @endif>{{trans('lang.inactive')}}</option>
                                    </select>
                                </div>
                                <div class="col-md-4 col-lg-4">
                                    <label for="product_id" style="margin-top:6px">{{trans('lang.product_id')}}</label>
                                    <input type="text" value="{{$products->product_id}}" name="product_id" id="product_id" class="product_id form-control" value="{{$products->product_id}}" placeholder="{{trans('lang.product_id')}}" style="pointer-events: none;">
                                </div>
                                <div class="col-md-4 col-lg-4">
                                    <label for="coloris" style="margin-top:6px">{{trans('lang.color')}}</label>
                                    <input type="text" id="coloris" name="color" class="coloris form-control color" placeholder="{{trans('lang.color')}}" value="{{$products->color}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <textarea name="details"  id="details" class="details form-control" cols="30" rows="5" placeholder="{{trans('lang.product_details')}}">{{$products->details}}</textarea>
                                </div>
                            </div>

                            <div class="form-group row">
                                <div class="col-md-12 col-lg-12">
                                    <input type="checkbox" class="download_update" id="download_update" name="download_update" @if($products->download_update == 1) checked @endif>
