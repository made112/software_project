...
@section('title')
    {{ trans('lang.add_new') . ' ' . __('lang.city') }}
@stop
@section('css')
    <style>
                            ...
                            <div class="mr-auto">
                                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                                    ...
                                    <li class="m-nav__item">
                                        <a href="#" class="m-nav__link ">
                                            <span
                                                class="m-nav__link-text text-dark">{{ trans('lang.add_new') . ' ' . __('lang.city') }}</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="col-md-12 col-lg-12">
                    <div class="m-portlet m-portlet--mobile" id="m_blockui_2_portlet">
                        ...
                        <div class="m-portlet__body">
                            <form action="{{ route('admin.cities.store') }}" class="add_city_form" method="post">
                                @csrf
                                <div class="form-group row">
                                    <div class="col-md-6 col-lg-6">
                                        <label for="name_ar">{{ trans('lang.name_ar') }}</label>
                                        <input type="text" name="name_ar" id="name_ar" class="name_ar form-control"
                                            placeholder="{{ trans('lang.name_ar') }}">
                                    </div>

                                    <div class="col-md-6 col-lg-6">
                                        <label for="name_en">{{ trans('lang.name_en') }}</label>
                                        <input type="text" name="name_en" id="name_en" class="name_en form-control"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        <input type="checkbox" class="status" id="status" name="status">
                                        <label for="status">
                                            {{ __('lang.active') }}
                                        </label>
                                    </div>
