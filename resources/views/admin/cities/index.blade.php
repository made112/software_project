                        ...
                        <div class="d-flex align-items-center">
                            <div class="mr-auto">
                                ...
                                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                                    ...
                                    <li class="m-nav__item">
                                        <a href="#" class="m-nav__link ">
                                            <span class="m-nav__link-text text-dark">{{ trans('lang.cities') }}</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
        ...
        <div class="data-content">
            <div class="row ">
                <div class="col-md-12 mb-4 ">
                    <h5 class="font-weight-bold float-left">{{ trans('lang.manage') . ' ' . __('lang.cities') }}</h5>
                    <div class="clearfix"></div>
                </div>
                <div class="col-md-10 col-lg-10 mb-4">
                    <div class="row">
                        <div class="col-md-3">
                            <select name="status" id="status" class="status form-control" style="color: #999da6">
                        ...
                        <div class="col-md-3">
                            <input type="text" class="name form-control" name="name" autocomplete="off"
                                placeholder="{{ trans('lang.name') }}">
                        </div>
                        <div class="col-md-3">
                            <select name="country" id="country" class="country_id form-control">
                ...
                <div class="col-md-2 col-lg-2 mb-4">
                    @can('add_cities')
                    <a href="{{ route('admin.cities.create') }}" class="btn btn-dark float-right">
                        {{ __('lang.add_new') }}
                    </a>
                    @endcan
                </div>
    ...
    <script>
        function getData(url) {
            ...
            $.ajax({
                ...
                $("#table-container").empty().html(data['data']);
            });
        }
        ...
        $(document).on('click', '.city_status', function(e) {
            e.preventDefault();
            var id = $(this).data('id');
            $('#load').show();
            $.ajaxSetup({
            ...
            $.ajax({
                url: "{{ route('admin.cities.update_status') }}",
                type: "POST",
                dataType: "JSON",
                data: {
                    id: id
                ...
                success: function(data) {
                    ...
                    var element = $('.city_status[data-id="' + data.city.id + '"]')
