            ...
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    ...
                    <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                        ...
                        <li class="m-nav__item">
                            <a href="#" class="m-nav__link ">
                                <span class="m-nav__link-text text-dark">{{trans('lang.downloads')}}</span>
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <div class="data-content">
        <div class="row ">
            <div class="col-md-12 mb-4">
                <h5 class="font-weight-bold float-left">{{trans('lang.view_update_downloads')}}</h5>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12">
                <div class="table-container" id="table-container">
                    @include('admin.downloads.table-data')
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function getData(url) {
        ...
        $.ajax({
            url : url,
            data:{status:status,name:name,product_id:product_id,client_id:client_id,from:from,to:to}
        }).done(function (data) {
...
<script>
    ...
    $(".client_id").select2({
        minimumInputLength: 2,
        allowClear: true,
        placeholder: "{{trans('lang.clients')}}",
        ajax: {
